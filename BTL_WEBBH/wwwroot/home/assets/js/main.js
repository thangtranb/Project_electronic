(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        /*quantityRanger: function () {
            $('.pro-qty').prepend('<a class="dec qtybtn" asp-controller="Cart" asp-action="Decrease" asp-route-Id="@item.ProductId">-</a>');
            $('.pro-qty').append('<a class="inc qtybtn" asp-controller="Cart" asp-action="Increase" asp-route-Id="@item.ProductId">+</a>');
            ...
            $('.qtybtn').on('click', function () {
                ...
                *//*var newVal;*//*
                ...
                // Gửi yêu cầu AJAX để cập nhật giỏ hàng phía server
                var productId = $button.attr('asp-route-Id');
                var actionUrl = $button.hasClass('inc') ? '/Cart/Increase' : '/Cart/Decrease';
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        // Tùy chọn: xử lý phản hồi, ví dụ như cập nhật giao diện giỏ hàng
                    },
                    error: function (xhr) {
                        // Xử lý lỗi (ví dụ: hiển thị thông báo cho người dùng)
                        console.log('Lỗi khi cập nhật số lượng: ', xhr.responseText);
                    }
                });
            });
        },*/
